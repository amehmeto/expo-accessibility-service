...
describe('Android Accessibility Service Integration Tests', () => {
  ...
  describe('Service Detection', () => {
    ...
    it('should detect when our service is not in enabled services list', async () => {
      const enabledServices =
        'com.other.service/.SomeService:com.another/.Service'
      mockSettings.Secure.getString.mockReturnValue(enabledServices)
  ...
  describe('Real-world Android Scenarios', () => {
    it('should handle typical Android accessibility services list format', async () => {
      ...
      const realWorldEnabledServices =
        'com.android.talkback/com.google.android.marvin.talkback.TalkBackService:com.example.testaccessibility/com.example.testaccessibility.MyAccessibilityService:com.google.android.apps.accessibility.voiceaccess/com.google.android.apps.accessibility.voiceaccess.JustSpeakService'
  ...
  describe('Android System Integration Edge Cases', () => {
    ...
    it('should handle malformed service names in system settings', async () => {
      const malformedServices =
        'invalid_format:com.example.testaccessibility/com.example.testaccessibility.MyAccessibilityService:another_invalid'
